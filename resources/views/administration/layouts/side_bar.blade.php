...
<div id="sidebar">
  <ul>
    ...
    <li class="{{ Request::is('administracion/solicitudes') ? 'active' : '' }}"> <a href="/administracion/solicitudes"><i class="icon icon-bell"></i> <span>Solicitudes</span> <span class="label label-important">{{ $request_qty }}</span></a> </li>
