      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-info-sign"></i> </span>
            <h5>Editar Categoria de Arma</h5>
          </div>
          <div class="widget-content nopadding">

            <form class="form-horizontal" method="post" action="/administracion/seguridad/armas/{{ $catWeapon->id }}">
              @method('PATCH')
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ $catWeapon->name }}" required>
                  @if ($errors->has('name'))
