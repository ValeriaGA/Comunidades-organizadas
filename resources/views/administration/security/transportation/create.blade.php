...
<div id="content">
  ...
  <div id="content-header">
    <div id="breadcrumb"> 
      <a href="/administracion" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="/administracion/seguridad">Seguridad</a> <a href="#" class="current">Transporte</a>
    </div>
  </div>
  <!--End-breadcrumbs-->
      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-info-sign"></i> </span>
            <h5>Crear medios de transporte</h5>
          </div>
